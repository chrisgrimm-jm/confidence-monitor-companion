...
export interface ModuleManifest {
  $schema?: string;
  /**
   * Type of module. Must be: connection
   */
  type: "connection";
  /**
...
export interface ModuleManifestRuntime {
  /**
   * Type of the module. Must be: node22 or node26
   */
  type: "node22" | "node26";
  /**
  ...
  permissions?: {
    ...
    filesystem?: boolean;
    /**
     * Enable if the module requires legacy openssl algorithms
     */
    "insecure-algorithms"?: boolean;
  };
}
