import { type HslaColor, type HsvaColor } from 'colord';
/**
 ...
 */
export declare function parseEscapeCharacters(msg: string): string;
/**
 * The reverse of parseEscapeCharacters. This is useful to ensure special characters are displayed normally when returned to the UI.
 * Ie during a learn callback, or as a variable
 */
export declare function substituteEscapeCharacters(msg: string): string;
