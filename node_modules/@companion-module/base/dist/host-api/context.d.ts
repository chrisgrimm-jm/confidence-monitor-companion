...
import type { CompanionActionDefinitions, CompanionFeedbackDefinitions, CompanionGraphicsCompositeElementDefinitions, CompanionPresetDefinitions, CompanionPresetSection, CompanionRecordedAction, CompanionStaticUpgradeScript, CompanionVariableDefinitions, InstanceStatus, InstanceTypes } from '../module-api/index.js';
import type { SharedUdpSocketImpl } from '../module-api/shared-udp-socket.js';
import type { StringKeys } from '../util.js';
export declare function isInstanceContext<TManifest extends InstanceTypes>(obj: unknown): obj is InstanceContext<TManifest>;
