...
export interface CompanionGraphicsCompositeElementDefinition<TSchema extends CompanionCompositeElementSchema<any> = CompanionCompositeElementSchema<any>> {
    type: 'composite';
 ...
 */
export type CompanionGraphicsCompositeElementDefinitions<TSchemas extends CompanionCompositeElementSchemas | undefined = Record<string, CompanionCompositeElementSchema<CompanionOptionValues>>> = {
    [K in keyof Extract<TSchemas, CompanionCompositeElementSchemas>]: CompanionGraphicsCompositeElementDefinition<Extract<TSchemas, CompanionCompositeElementSchemas>[K]> | false | undefined;
};
//# sourceMappingURL=graphics-composite.d.ts.map