...
import type { CompanionInputFieldCheckbox, CompanionInputFieldColor, CompanionInputFieldDropdown, CompanionInputFieldMultiDropdown, CompanionInputFieldNumber, CompanionInputFieldStaticText, CompanionInputFieldTextInput, CompanionOptionValues } from './input.js';
import type { CompanionButtonStyleProps } from './style.js';
export type SomeCompanionFeedbackInputField<TKey extends string = string> = CompanionInputFieldStaticText<TKey> | CompanionInputFieldColor<TKey> | CompanionInputFieldTextInput<TKey> | CompanionInputFieldDropdown<TKey> | CompanionInputFieldMultiDropdown<TKey> | CompanionInputFieldNumber<TKey> | CompanionInputFieldCheckbox<TKey>;
 ...
 */
export type CompanionFeedbackBooleanEvent<TOptions extends CompanionOptionValues = CompanionOptionValues> = CompanionFeedbackInfo<TOptions>;
/**
 * Extended information for execution of a value feedback
 */
export type CompanionFeedbackValueEvent<TOptions extends CompanionOptionValues = CompanionOptionValues> = CompanionFeedbackInfo<TOptions>;
/**
 * Extended information for execution of an advanced feedback
 */
export interface CompanionFeedbackAdvancedEvent<TOptions extends CompanionOptionValues = CompanionOptionValues> extends CompanionFeedbackInfo<TOptions> {
...
export interface CompanionFeedbackDefinitionBase<TOptions extends CompanionOptionValues = CompanionOptionValues> {
     ...
     */
    learn?: (feedback: CompanionFeedbackInfo<TOptions>, context: CompanionFeedbackLearnContext) => Partial<TOptions> | undefined | Promise<Partial<TOptions> | undefined>;
    /**
 ...
 */
export interface CompanionBooleanFeedbackDefinition<TOptions extends CompanionOptionValues = CompanionOptionValues> extends CompanionFeedbackDefinitionBase<TOptions> {
    /** The type of the feedback */
    type: 'boolean';
    ...
    callback: (feedback: CompanionFeedbackBooleanEvent<TOptions>, context: CompanionFeedbackCallbackContext) => boolean | Promise<boolean>;
    /**
 ...
 */
export interface CompanionValueFeedbackDefinition<TOptions extends CompanionOptionValues = CompanionOptionValues> extends CompanionFeedbackDefinitionBase<TOptions> {
    /** The type of the feedback */
    type: 'value';
    /** Called to get the feedback value */
    callback: (feedback: CompanionFeedbackValueEvent<TOptions>, context: CompanionFeedbackCallbackContext) => JsonValue | Promise<JsonValue>;
}
/**
 ...
 */
export interface CompanionAdvancedFeedbackDefinition<TOptions extends CompanionOptionValues = CompanionOptionValues> extends CompanionFeedbackDefinitionBase<TOptions> {
    /** The type of the feedback */
    type: 'advanced';
    /**
    ...
    /** Called to get the feedback value */
    callback: (feedback: CompanionFeedbackAdvancedEvent<TOptions>, context: CompanionFeedbackCallbackContext) => CompanionAdvancedFeedbackResult | Promise<CompanionAdvancedFeedbackResult>;
}
/**
 ...
 */
export type CompanionFeedbackDefinition<TSchema extends CompanionFeedbackSchema<CompanionOptionValues> = CompanionFeedbackSchema<CompanionOptionValues>> = TSchema extends CompanionFeedbackSchema<infer TOptions> ? TSchema['type'] extends 'boolean' ? CompanionBooleanFeedbackDefinition<TOptions> : TSchema['type'] extends 'value' ? CompanionValueFeedbackDefinition<TOptions> : TSchema['type'] extends 'advanced' ? CompanionAdvancedFeedbackDefinition<TOptions> : CompanionBooleanFeedbackDefinition<TOptions> | CompanionValueFeedbackDefinition<TOptions> | CompanionAdvancedFeedbackDefinition<TOptions> : never;
/**
 * The definitions of a group of feedbacks
 */
export type CompanionFeedbackDefinitions<TSchemas extends Record<string, CompanionFeedbackSchema<CompanionOptionValues>> = Record<string, CompanionFeedbackSchema<CompanionOptionValues>>> = {
