...
import type { CompanionButtonStepActions, CompanionInternalLogicFeedbackSchemas, CompanionPresetDefinitionBase, CompanionPresetLocalVariable, CompanionPresetOptionValues, CompanionPresetValue, MapChildren, WithInternalFeedbacks } from './definition.js';
/**
 ...
 */
export interface CompanionLayeredButtonPresetDefinition<TManifest extends InstanceTypes = InstanceTypes> extends CompanionPresetDefinitionBase<'layered'> {
 ...
 */
export type CompanionPresetLayeredFeedback<TFeedbackManifest extends Record<string, CompanionFeedbackSchema<CompanionOptionValues>> = Record<string, CompanionFeedbackSchema<CompanionOptionValues>>> = {
...
export type SomePresetLayeredFeedbackEntry<TManifest extends InstanceTypes = InstanceTypes> = CompanionPresetLayeredFeedback<WithInternalFeedbacks<TManifest['feedbacks']>> | CompanionInternalLayeredLogicFeedback<TManifest>;
//# sourceMappingURL=definition-graphics.d.ts.map