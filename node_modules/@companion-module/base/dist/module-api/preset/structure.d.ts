...
export type CompanionPresetGroup<TManifest extends InstanceTypes = InstanceTypes> = CompanionPresetGroupSimple<TManifest> | CompanionPresetGroupTemplate<TManifest>;
export type CompanionPresetReference = string;
export interface CompanionPresetGroupSimple<_TManifest extends InstanceTypes = InstanceTypes> extends CompanionPresetGroupBase<'simple'> {
    /**
 ...
 */
export interface CompanionPresetGroupTemplate<_TManifest extends InstanceTypes = InstanceTypes> extends CompanionPresetGroupBase<'template'> {
    /**
