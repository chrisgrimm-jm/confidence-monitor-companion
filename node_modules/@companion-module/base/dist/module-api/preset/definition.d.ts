...
type ChildArray<TKind, TManifest extends InstanceTypes> = NonNullable<TKind> extends 'conditions' ? SomePresetConditionEntry<TManifest>[] : SomePresetActionEntry<TManifest>[];
/**
...
export interface CompanionInternalLogicActionSchemas {
    ...
    'internal:actionGroup': {
        options: {
            executionMode?: 'inherit' | 'concurrent' | 'sequential';
        };
        children: {
            default: 'actions';
        };
 ...
 */
export type CompanionPresetConditionFeedback<TFeedbackManifest extends Record<string, CompanionFeedbackSchema<CompanionOptionValues>>> = string extends keyof TFeedbackManifest ? {
    feedbackId: string;
...
export type SomePresetActionEntry<TManifest extends InstanceTypes = InstanceTypes> = CompanionPresetAction<WithInternalActions<TManifest['actions']>> | CompanionInternalLogicAction<TManifest>;
/** A condition entry (boolean feedback or nested logic operator) used inside a building block. */
export type SomePresetConditionEntry<TManifest extends InstanceTypes = InstanceTypes> = CompanionPresetConditionFeedback<WithInternalFeedbacks<TManifest['feedbacks']>> | CompanionInternalConditionFeedback<TManifest>;
/** A feedback entry on a simple preset: the module's own or internal feedbacks, plus internal building blocks. */
export type SomePresetSimpleFeedbackEntry<TManifest extends InstanceTypes = InstanceTypes> = CompanionPresetFeedback<WithInternalFeedbacks<TManifest['feedbacks']>> | CompanionInternalSimpleLogicFeedback<TManifest>;
/**
 ...
 */
export type CompanionSomePresetDefinition<TManifest extends InstanceTypes = InstanceTypes> = CompanionPresetDefinition<TManifest> | CompanionPresetAlternatives<TManifest>;
export type CompanionPresetDefinition<TManifest extends InstanceTypes = InstanceTypes> = CompanionSimplePresetDefinition<TManifest> | CompanionLayeredButtonPresetDefinition<TManifest>;
/**
...
export interface CompanionSimplePresetDefinition<TManifest extends InstanceTypes = InstanceTypes> extends CompanionPresetDefinitionBase<'simple'> {
 ...
 */
export type CompanionPresetFeedback<TFeedbackManifest extends Record<string, CompanionFeedbackSchema<CompanionOptionValues>> = Record<string, CompanionFeedbackSchema<CompanionOptionValues>>> = {
...
export type CompanionFeedbackLocalVariable<TFeedbackManifest extends Record<string, CompanionFeedbackSchema<CompanionOptionValues>> = Record<string, CompanionFeedbackSchema<CompanionOptionValues>>> = {
...
export type CompanionPresetLocalVariable<TFeedbackManifest extends Record<string, CompanionFeedbackSchema<CompanionOptionValues>> = Record<string, CompanionFeedbackSchema<CompanionOptionValues>>> = CompanionSimplePresetLocalVariable | CompanionFeedbackLocalVariable<TFeedbackManifest>;
