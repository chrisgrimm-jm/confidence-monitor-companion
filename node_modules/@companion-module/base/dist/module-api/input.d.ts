...
export type ExpressionOrValue<T> = {
    value: T;
    isExpression: false;
} | {
    value: string;
...
export type CompanionOptionValues = {
...
export interface CompanionInputFieldBase<TKey extends string = string> {
    ...
    type: 'static-text' | 'textinput' | 'dropdown' | 'multidropdown' | 'colorpicker' | 'number' | 'checkbox' | 'custom-variable' | 'bonjour-device' | 'secret-text';
 ...
 * ```
 */
export interface CompanionInputFieldDropdown<TKey extends string = string, TChoiceId extends JsonValue = string | number> extends CompanionInputFieldBase<TKey> {
    type: 'dropdown';
 ...
 * ```
 */
export interface CompanionInputFieldMultiDropdown<TKey extends string = string, TChoiceId extends JsonValue = string | number> extends CompanionInputFieldBase<TKey> {
    type: 'multidropdown';
    /** The possible choices */
    choices: DropdownChoice<TChoiceId>[];
