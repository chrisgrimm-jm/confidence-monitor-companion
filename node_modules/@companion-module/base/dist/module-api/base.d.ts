...
import type { CompanionActionDefinitions, CompanionActionSchemaWithoutResult, CompanionActionSchemaWithResult, CompanionRecordedAction } from './action.js';
...
import type { CompanionCompositeElementSchema, CompanionGraphicsCompositeElementDefinitions } from './graphics-composite.js';
...
import { type SharedUdpSocket, type SharedUdpSocketMessageCallback, type SharedUdpSocketOptions } from './shared-udp-socket.js';
...
export type InstanceConstructor<TManifest extends InstanceTypes = InstanceTypes> = new (internal: unknown) => InstanceBase<TManifest>;
export declare abstract class InstanceBase<TManifest extends InstanceTypes = InstanceTypes> {
    #private;
    get id(): string;
     ...
     */
    saveConfig(this: InstanceBase<TManifest & {
        secrets: undefined;
    }>, newConfig: TManifest['config'] | undefined): void;
    saveConfig(this: InstanceBase<TManifest>, newConfig: TManifest['config'] | undefined, newSecrets: TManifest['secrets'] | undefined): void;
    /**
     ...
     */
    setCompositeElementDefinitions(compositeElements: CompanionGraphicsCompositeElementDefinitions<TManifest['compositeElements']>): void;
    /**
     ...
     */
    checkFeedbacks(feedbackType: StringKeys<TManifest['feedbacks']>, ...feedbackTypes: StringKeys<TManifest['feedbacks']>[]): void;
    /**
