 ...
 */
export type CompanionStaticUpgradeScript<TConfig extends JsonObject, TSecrets extends JsonObject | undefined = undefined> = (context: CompanionUpgradeContext<TConfig>, props: CompanionStaticUpgradeProps<TConfig, TSecrets>) => CompanionStaticUpgradeResult<TConfig, TSecrets>;
 ...
 */
export declare const EmptyUpgradeScript: CompanionStaticUpgradeScript<any, any>;
/**
 ...
 */
export declare function CreateConvertToBooleanFeedbackUpgradeScript<TConfig extends JsonObject = JsonObject>(upgradeMap: CompanionUpgradeToBooleanFeedbackMap): CompanionStaticUpgradeScript<TConfig, any>;
/**
 ...
 */
export declare function CreateUseBuiltinInvertForFeedbacksUpgradeScript<TConfig extends JsonObject, TSecrets extends JsonObject | undefined = undefined>(upgradeMap: Record<string, string>): CompanionStaticUpgradeScript<TConfig, TSecrets>;
/**
 ...
 */
export declare function CreateUseActionResultStoreUpgradeScript<TConfig extends JsonObject, TSecrets extends JsonObject | undefined = undefined>(upgradeMap: Record<string, string>): CompanionStaticUpgradeScript<TConfig, TSecrets>;
/**
 ...
 */
export declare function FixupNumericOrVariablesValueToExpressions(value: ExpressionOrValue<JsonValue | undefined> | undefined): ExpressionOrValue<JsonValue | undefined> | undefined;
/**
 ...
 * @returns The fixed up value, or the original value if it did not need to be changed
 */
export declare function FixupBooleanOrVariablesValueToExpressions(value: ExpressionOrValue<JsonValue | undefined> | undefined): ExpressionOrValue<JsonValue | undefined> | undefined;
