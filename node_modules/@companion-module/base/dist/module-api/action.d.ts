...
import type { CompanionInputFieldCheckbox, CompanionInputFieldColor, CompanionInputFieldCustomVariable, CompanionInputFieldDropdown, CompanionInputFieldMultiDropdown, CompanionInputFieldNumber, CompanionInputFieldStaticText, CompanionInputFieldTextInput, CompanionOptionValues } from './input.js';
import type { CompanionVariableValue } from './variable.js';
export type SomeCompanionActionInputField<TKey extends string = string> = CompanionInputFieldStaticText<TKey> | CompanionInputFieldColor<TKey> | CompanionInputFieldTextInput<TKey> | CompanionInputFieldDropdown<TKey> | CompanionInputFieldMultiDropdown<TKey> | CompanionInputFieldNumber<TKey> | CompanionInputFieldCheckbox<TKey> | CompanionInputFieldCustomVariable<TKey>;
 ...
 */
export interface CompanionActionSchemaWithResult<TOptions extends CompanionOptionValues, TResult extends JsonValue> extends CompanionActionSchemaOptions<TOptions> {
    /**
 ...
 * type.
 */
export interface CompanionActionSchemaWithoutResult<TOptions extends CompanionOptionValues> extends CompanionActionSchemaOptions<TOptions> {
    /**
...
export type CompanionActionSchema<TOptions extends CompanionOptionValues, TResult extends JsonValue | void> = [
    TResult
] extends [JsonValue] ? CompanionActionSchemaWithResult<TOptions, TResult> : [TResult] extends [void] ? CompanionActionSchemaWithoutResult<TOptions> : never;
/**
...
export interface CompanionActionDefinitionBase<TOptions extends CompanionOptionValues> {
     ...
     */
    learn?: (action: CompanionActionEvent<TOptions>, context: CompanionActionLearnContext) => Partial<TOptions> | undefined | Promise<Partial<TOptions> | undefined>;
    /**
 ...
 */
export type CompanionActionDefinitionCallbackWithResult<TOptions extends CompanionOptionValues, TResult extends JsonValue> = {
    /**
     * A function called when the callback executes, potentially returning a
     * result value.
     */
    callback: (action: CompanionActionEvent<TOptions>, context: CompanionActionCallbackContext) => Promise<TResult> | TResult;
    hasResult: true;
};
/**
 ...
 */
export type CompanionActionDefinition<TSchema extends CompanionActionSchemaWithoutResult<CompanionOptionValues> | CompanionActionSchemaWithResult<CompanionOptionValues, JsonValue> = CompanionActionSchemaWithoutResult<CompanionOptionValues> | CompanionActionSchemaWithResult<CompanionOptionValues, JsonValue>> = TSchema extends CompanionActionSchemaWithResult<infer Options, infer Result> ? CompanionActionDefinitionBase<Options> & (CompanionActionDefinitionSubscribeHooks<Options> | CompanionActionDefinitionNoSubscribeHooks) & CompanionActionDefinitionCallbackWithResult<Options, Result> : TSchema extends CompanionActionSchemaWithoutResult<infer Options> ? CompanionActionDefinitionBase<Options> & (CompanionActionDefinitionSubscribeHooks<Options> | CompanionActionDefinitionNoSubscribeHooks) & CompanionActionDefinitionCallbackWithoutResult<Options> : never;
/**
 * The definition of a set of actions, as a record of
 * {@link CompanionActionDefinition}s.
 */
export type CompanionActionDefinitions<Tschemas extends Record<string, CompanionActionSchemaWithoutResult<CompanionOptionValues> | CompanionActionSchemaWithResult<CompanionOptionValues, JsonValue>> = Record<string, CompanionActionSchemaWithoutResult<CompanionOptionValues> | CompanionActionSchemaWithResult<CompanionOptionValues, JsonValue>>> = {
    [K in keyof Tschemas]: Tschemas[K] extends infer Schema ? Schema extends CompanionActionSchemaWithResult<infer Options, infer Result> ? (CompanionActionDefinitionBase<Options> & (CompanionActionDefinitionSubscribeHooks<Options> | CompanionActionDefinitionNoSubscribeHooks) & CompanionActionDefinitionCallbackWithResult<Options, Result>) | false | undefined : Schema extends CompanionActionSchemaWithoutResult<infer Options> ? (CompanionActionDefinitionBase<Options> & (CompanionActionDefinitionSubscribeHooks<Options> | CompanionActionDefinitionNoSubscribeHooks) & CompanionActionDefinitionCallbackWithoutResult<Options>) | false | undefined : never : never;
};
/**
 ...
 */
export interface CompanionActionEvent<TOptions extends CompanionOptionValues = CompanionOptionValues> extends CompanionActionInfo<TOptions> {
